                    ...
                    <Card className="bg-muted/50">
                      <CardContent className="p-3 space-y-2 text-xs">
                        <div className="grid grid-cols-2 gap-2">
                          ...
                          <div><span className="text-muted-foreground">Score:</span> <strong>{parsedResult.score}/100</strong></div>
            ...
            <Dialog open={importOpen} onOpenChange={setImportOpen}>
              ...
              <DialogContent>
                ...
                <div className="space-y-3">
                  ...
                  <div><Label className="text-xs">Service Needed</Label><Input value={manualForm.service_needed} onChange={e => setManualForm({...manualForm, service_needed: e.target.value})} className="h-8 text-xs mt-1" placeholder="e.g. Weekly Cleaning, Deep Clean, Bond Clean" /></div>
                  <div className="grid grid-cols-2 gap-3">
                    <div>
