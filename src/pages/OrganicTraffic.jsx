  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 p-3 rounded-lg border border-amber-500/30 bg-amber-500/5">
        ...
        <p className="text-xs text-amber-700"><strong>Needs API connection / setup required</strong> — Google Analytics and Google Search Console are not connected. Recommendations are generated from internal data only.</p>
      </div>
