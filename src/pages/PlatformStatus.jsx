...
export default function PlatformStatus() {
  ...
  const issueCount = connections.filter(c => !['connected', 'fallback_active'].includes(c.connection_status)).length;
            ...
            <CardContent className="p-4 flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                {['connected', 'fallback_active'].includes(conn.connection_status)
                  ...
                  : <span className="text-[10px] px-2 py-0.5 rounded-full border bg-amber-50 text-amber-700 border-amber-300 whitespace-nowrap">Needs API connection / setup required</span>
                }
