...
const SERVICE_TYPES = ['deep_clean','fortnightly','weekly','office_cleaning','commercial','hoarder_heavy','inspection_rescue','one_off_urgent','airbnb_shortstay','window_cleaning','pressure_washing','post_build_clean','other'];
            ...
            <Dialog open={parseOpen} onOpenChange={setParseOpen}>
              ...
              <DialogContent className="max-w-lg">
                ...
                <div className="space-y-3">
                  ...
                  <Button onClick={() => parseMutation.mutate({ business_id: bid, text: pasteText, source: pasteSource })} disabled={parseMutation.isPending || !pasteText.trim()} className="w-full">
              ...
              <DialogContent>
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div><Label className="text-xs">Contact</Label><Input value={manualForm.contact_details} onChange={e => setManualForm({...manualForm, contact_details: e.target.value})} className="h-8 text-xs mt-1" /></div>
                  </div>
        ...
        <Card className="border-amber-500/20 bg-amber-500/5">
          <CardContent className="p-3 space-y-2">
            ...
            <div className="space-y-1.5 text-[10px] text-amber-700">
              <p><strong>✓ URL Watchlist:</strong> Active — but no URLs added yet. Go to the Watchlist page and add URLs to monitor.</p>
              <p><strong>⚠ Facebook Groups:</strong> Requires valid configuration in Settings.</p>
              <p><strong>⚠ Gumtree:</strong> Requires configuration in Settings.</p>
            </div>
          </CardContent>
        </Card>
      )}
