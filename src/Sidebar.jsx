...
import {
  ...
  History, Bell, Clock, CheckSquare, Settings, Link2, X, Bot, Sparkles, FolderOpen, Inbox, Users, FileSignature, Briefcase, Tag, FlaskConical
} from 'lucide-react';
...
const navItems = [
  ...
  { label: 'Chemical Register', icon: FlaskConical, path: '/chemicals' },
